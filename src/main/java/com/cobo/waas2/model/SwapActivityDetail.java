...
public class SwapActivityDetail {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activityId, swapType, status, requestId, walletId, payTokenId, receiveTokenId, payAmount, receiveAmount, feeAmount, initiator, initiatorType, description, createdTimestamp, updatedTimestamp, timeline, additionalProperties);
  }
