...
public class MessageSignDestination extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<MessageSignDestination>() {
                ...
                public void write(JsonWriter out, MessageSignDestination value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: BTCBIP322MessageSignDestination, BTCEIP191MessageSignDestination, CosmosAdr36MessageSignDestination, EvmEIP191MessageSignDestination, EvmEIP712MessageSignDestination, RawMessageSignDestination");
                }
                    ...
                    if (jsonObject.get("destination_type") == null) {
                        ...
                        switch (jsonObject.get("destination_type").getAsString()) {
                            ...
                            case "RawMessageSignDestination":
                                ...
                                return newMessageSignDestination;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for MessageSignDestination. Possible values: BTC_BIP_322_Signature BTC_EIP_191_Signature COSMOS_ADR_36_Signature EVM_EIP_191_Signature EVM_EIP_712_Signature RAW_MESSAGE BTCBIP322MessageSignDestination BTCEIP191MessageSignDestination CosmosAdr36MessageSignDestination EvmEIP191MessageSignDestination EvmEIP712MessageSignDestination RawMessageSignDestination", jsonObject.get("destination_type").getAsString()));
                        }
                    }
     ...
     * BTCBIP322MessageSignDestination, BTCEIP191MessageSignDestination, CosmosAdr36MessageSignDestination, EvmEIP191MessageSignDestination, EvmEIP712MessageSignDestination, RawMessageSignDestination
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BTCBIP322MessageSignDestination, BTCEIP191MessageSignDestination, CosmosAdr36MessageSignDestination, EvmEIP191MessageSignDestination, EvmEIP712MessageSignDestination, RawMessageSignDestination");
    }
     ...
     * BTCBIP322MessageSignDestination, BTCEIP191MessageSignDestination, CosmosAdr36MessageSignDestination, EvmEIP191MessageSignDestination, EvmEIP712MessageSignDestination, RawMessageSignDestination
     *
     * @return The actual instance (BTCBIP322MessageSignDestination, BTCEIP191MessageSignDestination, CosmosAdr36MessageSignDestination, EvmEIP191MessageSignDestination, EvmEIP712MessageSignDestination, RawMessageSignDestination)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            // throw new IOException(String.format("The JSON string is invalid for MessageSignDestination with oneOf schemas: BTCBIP322MessageSignDestination, BTCEIP191MessageSignDestination, CosmosAdr36MessageSignDestination, EvmEIP191MessageSignDestination, EvmEIP712MessageSignDestination, RawMessageSignDestination. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
