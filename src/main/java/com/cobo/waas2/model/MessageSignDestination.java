                    ...
                    if (jsonObject.get("destination_type") == null) {
                        ...
                        switch (jsonObject.get("destination_type").getAsString()) {
                            ...
                            case "RawMessageSignDestination":
                                ...
                                return newMessageSignDestination;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for MessageSignDestination. Possible values: BTC_BIP_137_Signature BTC_BIP_322_Signature BTC_EIP_191_Signature COSMOS_ADR_36_Signature EVM_EIP_191_Signature EVM_EIP_712_Signature RAW_MESSAGE BTCBIP137MessageSignDestination BTCBIP322MessageSignDestination BTCEIP191MessageSignDestination CosmosAdr36MessageSignDestination EvmEIP191MessageSignDestination EvmEIP712MessageSignDestination RawMessageSignDestination", jsonObject.get("destination_type").getAsString()));
                        }
                    }
