...
public class TokenizationEstimateFeeRequestOperationParams extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<TokenizationDeployEstimateFeeParams> adapterTokenizationDeployEstimateFeeParams = gson.getDelegateAdapter(this, TypeToken.get(TokenizationDeployEstimateFeeParams.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<TokenizationEstimateFeeRequestOperationParams>() {
                ...
                public void write(JsonWriter out, TokenizationEstimateFeeRequestOperationParams value) throws IOException {
                    ...
                    // check if the actual instance is of the type `TokenizationDeployEstimateFeeParams`
                    if (value.getActualInstance() instanceof TokenizationDeployEstimateFeeParams) {
                        JsonElement element = adapterTokenizationDeployEstimateFeeParams.toJsonTree((TokenizationDeployEstimateFeeParams)value.getActualInstance());
                ...
                public TokenizationEstimateFeeRequestOperationParams read(JsonReader in) throws IOException {
                    ...
                    if (jsonObject.get("operation_type") == null) {
                        ...
                        switch (jsonObject.get("operation_type").getAsString()) {
                            ...
                            case "ContractCall":
                                ...
                                return newTokenizationEstimateFeeRequestOperationParams;
                            case "Deploy":
                                deserialized = adapterTokenizationDeployEstimateFeeParams.fromJsonTree(jsonObject);
                                newTokenizationEstimateFeeRequestOperationParams.setActualInstance(deserialized);
                                return newTokenizationEstimateFeeRequestOperationParams;
                            case "Issue":
                            ...
                            case "TokenizationContractCallEstimateFeeParams":
                                ...
                                newTokenizationEstimateFeeRequestOperationParams.setActualInstance(deserialized);
                                return newTokenizationEstimateFeeRequestOperationParams;
                            case "TokenizationDeployEstimateFeeParams":
                                deserialized = adapterTokenizationDeployEstimateFeeParams.fromJsonTree(jsonObject);
                                newTokenizationEstimateFeeRequestOperationParams.setActualInstance(deserialized);
                                return newTokenizationEstimateFeeRequestOperationParams;
                            ...
                            case "TokenizationUpdateBlocklistAddressesEstimateFeeParams":
                                ...
                                return newTokenizationEstimateFeeRequestOperationParams;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for TokenizationEstimateFeeRequestOperationParams. Possible values: Burn ContractCall Deploy Issue Mint Pause ToggleAllowlist Unpause UpdateAllowlistAddresses UpdateBlocklistAddresses TokenizationBurnEstimateFeeParams TokenizationContractCallEstimateFeeParams TokenizationDeployEstimateFeeParams TokenizationIssueEstimateFeeParams TokenizationMintEstimateFeeParams TokenizationPauseEstimateFeeParams TokenizationToggleAllowlistEstimateFeeParams TokenizationUnpauseEstimateFeeParams TokenizationUpdateAllowlistAddressesEstimateFeeParams TokenizationUpdateBlocklistAddressesEstimateFeeParams", jsonObject.get("operation_type").getAsString()));
                        }
                    }
                    ...
                    // deserialize TokenizationDeployEstimateFeeParams
                    try {
                        // validate the JSON object to see if any exception is thrown
                        TokenizationDeployEstimateFeeParams.validateJsonElement(jsonElement);
                        actualAdapter = adapterTokenizationDeployEstimateFeeParams;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'TokenizationDeployEstimateFeeParams'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for TokenizationDeployEstimateFeeParams failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'TokenizationDeployEstimateFeeParams'", e);
                    }
    ...
    public TokenizationEstimateFeeRequestOperationParams(TokenizationDeployEstimateFeeParams o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        schemas.put("TokenizationDeployEstimateFeeParams", TokenizationDeployEstimateFeeParams.class);
    ...
    public void setActualInstance(Object instance) {
        if (instance instanceof TokenizationDeployEstimateFeeParams) {
    ...
    /**
     * Get the actual instance of `TokenizationDeployEstimateFeeParams`. If the actual instance is not `TokenizationDeployEstimateFeeParams`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `TokenizationDeployEstimateFeeParams`
     * @throws ClassCastException if the instance is not `TokenizationDeployEstimateFeeParams`
     */
    public TokenizationDeployEstimateFeeParams getTokenizationDeployEstimateFeeParams() throws ClassCastException {
        return (TokenizationDeployEstimateFeeParams)super.getActualInstance();
    }
    /**
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with TokenizationDeployEstimateFeeParams
        try {
            TokenizationDeployEstimateFeeParams.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
