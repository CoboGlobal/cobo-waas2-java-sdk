...
public class CreateRefundRequest {
  ...
  **/
  ...
  public CreateRefundRequest amount(String amount) {
   ...
   /**
   * The amount of tokens to refund.
   * @return amount
  **/
  ...
  **/
  ...
  public CreateRefundRequest orderId(String orderId) {
   ...
   /**
   * (Optional) The order id associated with the refund.
   * @return orderId
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.merchantId, createRefundRequest.merchantId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(merchantId, amount, toAddress, tokenId, refundType, orderId, additionalProperties);
  }
