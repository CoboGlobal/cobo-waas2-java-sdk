...
public class GetExchangeRate200Response {
  ...
  **/
  ...
  public GetExchangeRate200Response rate(String rate) {
   ...
   /**
   * The current exchange rate between the specified cryptocurrency token and currency. Expressed as the amount of currency per one unit of cryptocurrency. For example, if the token is USDT and the currency is USD, a rate of \&quot;0.99\&quot; means 1 USDT &#x3D; 0.99 USD.
   * @return rate
  **/
  @javax.annotation.Nonnull
