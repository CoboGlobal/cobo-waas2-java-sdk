...
public class PaymentApi {
     ...
     * @param createPaymentOrderRequest The request body to create a payment order. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param tokenId The token ID, which identifies the cryptocurrency token for the payment operation. Supported values:    - USDC: &#x60;ETH_USDC&#x60;, &#x60;ARBITRUM_USDC&#x60;, &#x60;SOL_USDC&#x60;, &#x60;BASE_USDC&#x60;, &#x60;MATIC_USDC&#x60;, &#x60;BSC_USDC&#x60;   - USDT: &#x60;TRON_USDT&#x60;, &#x60;ETH_USDT&#x60;, &#x60;ARBITRUM_USDT&#x60;, &#x60;SOL_USDT&#x60;, &#x60;BASE_USDT&#x60;, &#x60;MATIC_USDT&#x60;, &#x60;BSC_USDT&#x60;  (required)
     * @param currency The currency for the operation. Currently, only &#x60;USD&#x60; is supported. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param orderId The payment order ID. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Get payment order information (asynchronously)
     * This operation retrieves details of a specific payment order. 
     * @param orderId The payment order ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Get settlement request detail by id (asynchronously)
     * This operation retrieves the information of target settlement request. 
     * @param settlementRequestId The settlement request ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * List all payment orders (asynchronously)
     * This operation retrieves the information of all payment orders. You can filter the result by merchant ID. 
     * @param limit The maximum number of objects to return. For most operations, the value range is [1, 50]. (optional, default to 10)
     * @param before This parameter specifies an object ID as a starting point for pagination, retrieving data before the specified object relative to the current dataset.    Suppose the current data is ordered as Object A, Object B, and Object C.  If you set &#x60;before&#x60; to the ID of Object C (&#x60;RqeEoTkgKG5rpzqYzg2Hd3szmPoj2cE7w5jWwShz3C1vyGSAk&#x60;), the response will include Object B and Object A.    **Notes**:   - If you set both &#x60;after&#x60; and &#x60;before&#x60;, an error will occur. - If you leave both &#x60;before&#x60; and &#x60;after&#x60; empty, the first page of data is returned. - If you set it to &#x60;infinity&#x60;, the last page of data is returned.  (optional)
     * @param after This parameter specifies an object ID as a starting point for pagination, retrieving data after the specified object relative to the current dataset.    Suppose the current data is ordered as Object A, Object B, and Object C. If you set &#x60;after&#x60; to the ID of Object A (&#x60;RqeEoTkgKG5rpzqYzg2Hd3szmPoj2cE7w5jWwShz3C1vyGSAk&#x60;), the response will include Object B and Object C.    **Notes**:   - If you set both &#x60;after&#x60; and &#x60;before&#x60;, an error will occur. - If you leave both &#x60;before&#x60; and &#x60;after&#x60; empty, the first page of data is returned.  (optional)
     ...
     * @param orderId The payment order ID. (required)
     * @param updatePaymentOrderRequest The request body to update a payment order. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * Update payment order (asynchronously)
     * This operation updates a payment order. Use this operation to expire a payment order that is no longer needed. 
     * @param orderId The payment order ID. (required)
     * @param updatePaymentOrderRequest The request body to update a payment order. (optional)
     * @param _callback The callback to be executed when the API call finishes
