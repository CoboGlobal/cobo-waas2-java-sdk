...
public class PaymentApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The request was successful. The response contains balance changes and pagination information. </td><td>  -  </td></tr>
        <tr><td> 4XX </td><td> Bad request. Your request contains malformed syntax or invalid parameters. </td><td>  -  </td></tr>
        <tr><td> 5XX </td><td> Internal server error. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listBalanceChangesCall(String sourceAccount, Integer limit, String before, String after, String tokenId, PaymentBalanceFlowDirection flowDirection, Long minCreatedTimestamp, Long maxCreatedTimestamp, PaymentBalanceChangeSourceType sourceType, String sourceId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/payments/balance_changes";
        ...
        if (flowDirection != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("flow_direction", flowDirection));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listBalanceChangesValidateBeforeCall(String sourceAccount, Integer limit, String before, String after, String tokenId, PaymentBalanceFlowDirection flowDirection, Long minCreatedTimestamp, Long maxCreatedTimestamp, PaymentBalanceChangeSourceType sourceType, String sourceId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sourceAccount' is set
        if (sourceAccount == null) {
            throw new ApiException("Missing the required parameter 'sourceAccount' when calling listBalanceChanges(Async)");
        }

        return listBalanceChangesCall(sourceAccount, limit, before, after, tokenId, flowDirection, minCreatedTimestamp, maxCreatedTimestamp, sourceType, sourceId, _callback);
     ...
     */
    public PaymentBalanceChangeResponse listBalanceChanges(String sourceAccount, Integer limit, String before, String after, String tokenId, PaymentBalanceFlowDirection flowDirection, Long minCreatedTimestamp, Long maxCreatedTimestamp, PaymentBalanceChangeSourceType sourceType, String sourceId) throws ApiException {
        ApiResponse<PaymentBalanceChangeResponse> localVarResp = listBalanceChangesWithHttpInfo(sourceAccount, limit, before, after, tokenId, flowDirection, minCreatedTimestamp, maxCreatedTimestamp, sourceType, sourceId);
        return localVarResp.getData();
    }
     ...
     * @param sourceType The source type used to filter balance changes. Possible values include: - &#x60;Init&#x60;: Balance change caused by initialization. - &#x60;OrderIn&#x60;: Balance change from an order-in payment. - &#x60;LatePayment&#x60;: Balance change from a late payment. - &#x60;TopUp&#x60;: Balance change from a top-up. - &#x60;UnexceptedIn&#x60;: Balance change from an unexpected incoming payment. - &#x60;RefundOut&#x60;: Balance change from a refund payout. - &#x60;Payout&#x60;: Balance change from a payout. - &#x60;UnexceptedOut&#x60;: Balance change from an unexpected outgoing payment. - &#x60;Allocation&#x60;: Balance change from an allocation. - &#x60;SettlementNetwork&#x60;: Balance change from the settlement network. - &#x60;BulkSend&#x60;: Balance change from a bulk send.  &lt;Note&gt;When specifying &#x60;source_id&#x60;, you must also specify &#x60;source_type&#x60;.&lt;/Note&gt;  (optional)
     * @param sourceId The source ID used to filter balance changes.  &lt;Note&gt;When specifying &#x60;source_id&#x60;, you must also specify &#x60;source_type&#x60;.&lt;/Note&gt;  (optional)
     * @return ApiResponse&lt;PaymentBalanceChangeResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PaymentBalanceChangeResponse> listBalanceChangesWithHttpInfo(String sourceAccount, Integer limit, String before, String after, String tokenId, PaymentBalanceFlowDirection flowDirection, Long minCreatedTimestamp, Long maxCreatedTimestamp, PaymentBalanceChangeSourceType sourceType, String sourceId) throws ApiException {
        okhttp3.Call localVarCall = listBalanceChangesValidateBeforeCall(sourceAccount, limit, before, after, tokenId, flowDirection, minCreatedTimestamp, maxCreatedTimestamp, sourceType, sourceId, null);
        Type localVarReturnType = new TypeToken<PaymentBalanceChangeResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List balance changes (asynchronously)
     * This operation retrieves balance changes for the specified source account. Each balance change includes the source information, token ID, changed amount, account balances before and after the change, flow direction, and creation time.  You need to specify &#x60;source_account&#x60;. Currently, use &#x60;developer&#x60; as the source account. You can use pagination parameters to control the response size, and filter balance changes by &#x60;token_id&#x60;, &#x60;flow_direction&#x60;, &#x60;min_created_timestamp&#x60;, &#x60;max_created_timestamp&#x60;, &#x60;source_type&#x60;, or &#x60;source_id&#x60;.  &lt;Note&gt;When specifying &#x60;source_id&#x60;, you must also specify &#x60;source_type&#x60;.&lt;/Note&gt;  For more information, see [Cobo Payments Guide](https://www.cobo.com/payments/en/guides/overview). 
     * @param sourceAccount The source account for which to retrieve balance changes. Currently, use &#x60;developer&#x60;. (required)
     * @param limit The maximum number of objects to return. For most operations, the value range is [1, 50]. (optional, default to 10)
     * @param before A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response.  (optional)
     ...
     */
    public okhttp3.Call listBalanceChangesAsync(String sourceAccount, Integer limit, String before, String after, String tokenId, PaymentBalanceFlowDirection flowDirection, Long minCreatedTimestamp, Long maxCreatedTimestamp, PaymentBalanceChangeSourceType sourceType, String sourceId, final ApiCallback<PaymentBalanceChangeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listBalanceChangesValidateBeforeCall(sourceAccount, limit, before, after, tokenId, flowDirection, minCreatedTimestamp, maxCreatedTimestamp, sourceType, sourceId, _callback);
        Type localVarReturnType = new TypeToken<PaymentBalanceChangeResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listBulkSendsCall(Integer limit, String before, String after, String requestId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listBulkSendsValidateBeforeCall(Integer limit, String before, String after, String requestId, final ApiCallback _callback) throws ApiException {
        return listBulkSendsCall(limit, before, after, requestId, _callback);
     ...
     */
    public ListBulkSends200Response listBulkSends(Integer limit, String before, String after, String requestId) throws ApiException {
        ApiResponse<ListBulkSends200Response> localVarResp = listBulkSendsWithHttpInfo(limit, before, after, requestId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListBulkSends200Response> listBulkSendsWithHttpInfo(Integer limit, String before, String after, String requestId) throws ApiException {
        okhttp3.Call localVarCall = listBulkSendsValidateBeforeCall(limit, before, after, requestId, null);
        Type localVarReturnType = new TypeToken<ListBulkSends200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listBulkSendsAsync(Integer limit, String before, String after, String requestId, final ApiCallback<ListBulkSends200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listBulkSendsValidateBeforeCall(limit, before, after, requestId, _callback);
        Type localVarReturnType = new TypeToken<ListBulkSends200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listPayerTransactionsCall(String customPayerId, Integer limit, String before, String after, String merchantId, String tokenId, String transactionHashes, String transactionIds, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/payments/topup/payers/transactions";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listPayerTransactionsValidateBeforeCall(String customPayerId, Integer limit, String before, String after, String merchantId, String tokenId, String transactionHashes, String transactionIds, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'customPayerId' is set
        if (customPayerId == null) {
            throw new ApiException("Missing the required parameter 'customPayerId' when calling listPayerTransactions(Async)");
        }

        return listPayerTransactionsCall(customPayerId, limit, before, after, merchantId, tokenId, transactionHashes, transactionIds, _callback);
     ...
     */
    public ListPayerTransactions200Response listPayerTransactions(String customPayerId, Integer limit, String before, String after, String merchantId, String tokenId, String transactionHashes, String transactionIds) throws ApiException {
        ApiResponse<ListPayerTransactions200Response> localVarResp = listPayerTransactionsWithHttpInfo(customPayerId, limit, before, after, merchantId, tokenId, transactionHashes, transactionIds);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListPayerTransactions200Response> listPayerTransactionsWithHttpInfo(String customPayerId, Integer limit, String before, String after, String merchantId, String tokenId, String transactionHashes, String transactionIds) throws ApiException {
        okhttp3.Call localVarCall = listPayerTransactionsValidateBeforeCall(customPayerId, limit, before, after, merchantId, tokenId, transactionHashes, transactionIds, null);
        Type localVarReturnType = new TypeToken<ListPayerTransactions200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List payer transactions (asynchronously)
     * This operation retrieves on-chain transactions related to a specific top-up payer.  You need to specify &#x60;custom_payer_id&#x60;, which is the merchant-defined customer identifier used when creating top-up addresses.  &lt;Note&gt;This operation is applicable to the top-up scenario only.&lt;/Note&gt;  For more information, see [Cobo Payments Guide](https://www.cobo.com/payments/en/guides/overview). 
     * @param customPayerId Unique customer identifier on the merchant side, used to allocate a dedicated top-up address  (required)
     * @param limit The maximum number of objects to return. For most operations, the value range is [1, 50]. (optional, default to 10)
     * @param before A cursor indicating the position before the current page. This value is generated by Cobo and returned in the response. If you are paginating forward from the beginning, you do not need to provide it on the first request. When paginating backward (to the previous page), you should pass the before value returned from the last response.  (optional)
     ...
     */
    public okhttp3.Call listPayerTransactionsAsync(String customPayerId, Integer limit, String before, String after, String merchantId, String tokenId, String transactionHashes, String transactionIds, final ApiCallback<ListPayerTransactions200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listPayerTransactionsValidateBeforeCall(customPayerId, limit, before, after, merchantId, tokenId, transactionHashes, transactionIds, _callback);
        Type localVarReturnType = new TypeToken<ListPayerTransactions200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
