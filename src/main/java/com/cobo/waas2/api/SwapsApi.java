...
public class SwapsApi {
     ...
     */
    public okhttp3.Call getSwapQuoteCall(String payTokenId, String receiveTokenId, String payAmount, String receiveAmount, UUID walletId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSwapQuoteValidateBeforeCall(String payTokenId, String receiveTokenId, String payAmount, String receiveAmount, UUID walletId, final ApiCallback _callback) throws ApiException {
        ...
        return getSwapQuoteCall(payTokenId, receiveTokenId, payAmount, receiveAmount, walletId, _callback);
     ...
     */
    public SwapQuote getSwapQuote(String payTokenId, String receiveTokenId, String payAmount, String receiveAmount, UUID walletId) throws ApiException {
        ApiResponse<SwapQuote> localVarResp = getSwapQuoteWithHttpInfo(payTokenId, receiveTokenId, payAmount, receiveAmount, walletId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SwapQuote> getSwapQuoteWithHttpInfo(String payTokenId, String receiveTokenId, String payAmount, String receiveAmount, UUID walletId) throws ApiException {
        okhttp3.Call localVarCall = getSwapQuoteValidateBeforeCall(payTokenId, receiveTokenId, payAmount, receiveAmount, walletId, null);
     ...
     */
    public okhttp3.Call getSwapQuoteAsync(String payTokenId, String receiveTokenId, String payAmount, String receiveAmount, UUID walletId, final ApiCallback<SwapQuote> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSwapQuoteValidateBeforeCall(payTokenId, receiveTokenId, payAmount, receiveAmount, walletId, _callback);
        Type localVarReturnType = new TypeToken<SwapQuote>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
