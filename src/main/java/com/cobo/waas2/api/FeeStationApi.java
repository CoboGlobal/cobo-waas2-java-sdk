...
public class FeeStationApi {
     ...
     */
    public okhttp3.Call listFeeStationTransactionsCall(String requestId, String coboIds, String transactionIds, String transactionHashes, String types, String statuses, String chainIds, String tokenIds, String assetIds, Long minCreatedTimestamp, Long maxCreatedTimestamp, Integer limit, String before, String after, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listFeeStationTransactionsValidateBeforeCall(String requestId, String coboIds, String transactionIds, String transactionHashes, String types, String statuses, String chainIds, String tokenIds, String assetIds, Long minCreatedTimestamp, Long maxCreatedTimestamp, Integer limit, String before, String after, final ApiCallback _callback) throws ApiException {
        return listFeeStationTransactionsCall(requestId, coboIds, transactionIds, transactionHashes, types, statuses, chainIds, tokenIds, assetIds, minCreatedTimestamp, maxCreatedTimestamp, limit, before, after, _callback);
     ...
     */
    public ListTransactions200Response listFeeStationTransactions(String requestId, String coboIds, String transactionIds, String transactionHashes, String types, String statuses, String chainIds, String tokenIds, String assetIds, Long minCreatedTimestamp, Long maxCreatedTimestamp, Integer limit, String before, String after) throws ApiException {
        ApiResponse<ListTransactions200Response> localVarResp = listFeeStationTransactionsWithHttpInfo(requestId, coboIds, transactionIds, transactionHashes, types, statuses, chainIds, tokenIds, assetIds, minCreatedTimestamp, maxCreatedTimestamp, limit, before, after);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListTransactions200Response> listFeeStationTransactionsWithHttpInfo(String requestId, String coboIds, String transactionIds, String transactionHashes, String types, String statuses, String chainIds, String tokenIds, String assetIds, Long minCreatedTimestamp, Long maxCreatedTimestamp, Integer limit, String before, String after) throws ApiException {
        okhttp3.Call localVarCall = listFeeStationTransactionsValidateBeforeCall(requestId, coboIds, transactionIds, transactionHashes, types, statuses, chainIds, tokenIds, assetIds, minCreatedTimestamp, maxCreatedTimestamp, limit, before, after, null);
     ...
     */
    public okhttp3.Call listFeeStationTransactionsAsync(String requestId, String coboIds, String transactionIds, String transactionHashes, String types, String statuses, String chainIds, String tokenIds, String assetIds, Long minCreatedTimestamp, Long maxCreatedTimestamp, Integer limit, String before, String after, final ApiCallback<ListTransactions200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listFeeStationTransactionsValidateBeforeCall(requestId, coboIds, transactionIds, transactionHashes, types, statuses, chainIds, tokenIds, assetIds, minCreatedTimestamp, maxCreatedTimestamp, limit, before, after, _callback);
        Type localVarReturnType = new TypeToken<ListTransactions200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
