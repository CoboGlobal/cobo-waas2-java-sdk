...
<a id="getSwapQuote"></a>
# **getSwapQuote**
> SwapQuote getSwapQuote(payTokenId, receiveTokenId, payAmount, receiveAmount, walletId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SwapQuote result = apiInstance.getSwapQuote(payTokenId, receiveTokenId, payAmount, receiveAmount, walletId);
      System.out.println(result);
    } catch (ApiException e) {
