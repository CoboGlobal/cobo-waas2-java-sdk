...
| [**createPaymentOrder**](PaymentApi.md#createPaymentOrder) | **POST** /payments/orders | Create payment order |
...
| [**getPaymentOrderDetailById**](PaymentApi.md#getPaymentOrderDetailById) | **GET** /payments/orders/{order_id} | Get payment order information |
...
| [**getSettlementById**](PaymentApi.md#getSettlementById) | **GET** /payments/settlement_requests/{settlement_request_id} | Get settlement request detail by id |
...
| [**listPaymentOrders**](PaymentApi.md#listPaymentOrders) | **GET** /payments/orders | List all payment orders |
...
| [**updatePaymentOrder**](PaymentApi.md#updatePaymentOrder) | **PUT** /payments/orders/{order_id} | Update payment order |
...
This operation creates a merchant and associates it with a specified wallet. Payments to the merchant will be deposited into the associated wallet.   Upon successful creation, a merchant ID is generated and returned along with the merchant&#39;s information. 
...
This operation creates a payment order. 
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **createPaymentOrderRequest** | [**CreatePaymentOrderRequest**](CreatePaymentOrderRequest.md)| The request body to create a payment order. | [optional] |
...
This operation creates a refund order to return cryptocurrency to a specified address.   When creating a refund order, you can optionally link it to an existing payment order for tracking and reconciliation purposes. 
...
This operation creates a settlement request to withdraw available balances.   You can include multiple merchants and cryptocurrency tokens in a single settlement request. 
...
This operation retrieves the current exchange rate between a specified cryptocurrency and currency pair. 
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **tokenId** | **String**| The token ID, which identifies the cryptocurrency token for the payment operation. Supported values:    - USDC: &#x60;ETH_USDC&#x60;, &#x60;ARBITRUM_USDC&#x60;, &#x60;SOL_USDC&#x60;, &#x60;BASE_USDC&#x60;, &#x60;MATIC_USDC&#x60;, &#x60;BSC_USDC&#x60;   - USDT: &#x60;TRON_USDT&#x60;, &#x60;ETH_USDT&#x60;, &#x60;ARBITRUM_USDT&#x60;, &#x60;SOL_USDT&#x60;, &#x60;BASE_USDT&#x60;, &#x60;MATIC_USDT&#x60;, &#x60;BSC_USDT&#x60;  | |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **orderId** | **String**| The payment order ID. | |
...
Get settlement request detail by id

This operation retrieves the information of target settlement request. 
...
> GetSettlementInfoByIds200Response getSettlementInfoByIds(merchantIds)

Get withdrawable balances

This operation retrieves the current withdrawable balances of specified merchants or the payment gateway. 
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetSettlementInfoByIds200Response result = apiInstance.getSettlementInfoByIds(merchantIds);
      System.out.println(result);
    } catch (ApiException e) {
...
This operation retrieves the information of all payment orders. You can filter the result by merchant ID. 
...
This operation updates the name or associated wallet ID of an existing merchant. 
...
This operation updates a payment order. Use this operation to expire a payment order that is no longer needed. 
...
|------------- | ------------- | ------------- | -------------|
| **orderId** | **String**| The payment order ID. | |
| **updatePaymentOrderRequest** | [**UpdatePaymentOrderRequest**](UpdatePaymentOrderRequest.md)| The request body to update a payment order. | [optional] |
