...
|------------- | ------------- | -------------|
| [**createBankAccount**](PaymentApi.md#createBankAccount) | **POST** /payments/bank_accounts | Create a new bank account |
| [**createMerchant**](PaymentApi.md#createMerchant) | **POST** /payments/merchants | Create new merchant for payment service provider |
| [**createPaymentOrder**](PaymentApi.md#createPaymentOrder) | **POST** /payments/orders | Create a new payment order |
| [**createRefund**](PaymentApi.md#createRefund) | **POST** /payments/merchants/refunds | Create a refund transaction |
| [**createSettlementRequest**](PaymentApi.md#createSettlementRequest) | **POST** /payments/settlement_requests | Create a new settlement request |
| [**getFiatRate**](PaymentApi.md#getFiatRate) | **GET** /payments/fiat_rates/{token_id}/{fiat_currency} | Get fiat exchange rate for a cryptocurrency |
| [**getPaymentOrderDetailById**](PaymentApi.md#getPaymentOrderDetailById) | **GET** /payments/orders/{order_id} | Retrieve a specific payment order |
| [**getRefundDetailById**](PaymentApi.md#getRefundDetailById) | **GET** /payments/merchants/refunds/{refund_id} | Retrieve a specific refund |
| [**getRefunds**](PaymentApi.md#getRefunds) | **GET** /payments/merchants/refunds | Get refunds |
| [**getSettlementInfoByIds**](PaymentApi.md#getSettlementInfoByIds) | **GET** /payments/merchants/settlement_info | Retrieve available settlement amounts |
| [**listBankAccounts**](PaymentApi.md#listBankAccounts) | **GET** /payments/bank_accounts | Retrieve a list of PSP bank accounts |
| [**listMerchants**](PaymentApi.md#listMerchants) | **GET** /payments/merchants | Retrieve a list of merchants |
| [**listPaymentOrders**](PaymentApi.md#listPaymentOrders) | **GET** /payments/orders | Retrieve a list of payment orders |
| [**listSettlementRequests**](PaymentApi.md#listSettlementRequests) | **GET** /payments/settlement_requests | Retrieve settlement request detail list |
| [**updateBankAccountById**](PaymentApi.md#updateBankAccountById) | **PUT** /payments/bank_accounts/{bank_account_id} | Update an existing bank account |
| [**updateMerchantById**](PaymentApi.md#updateMerchantById) | **PUT** /payments/merchants/{merchant_id} | Update an existing merchant |
| [**updatePaymentOrder**](PaymentApi.md#updatePaymentOrder) | **PUT** /payments/orders/{order_id} | Update a payment order |
...
|------------- | ------------- | ------------- | -------------|
| **createBankAccountRequest** | [**CreateBankAccountRequest**](CreateBankAccountRequest.md)| The request body to create a new bank account. | [optional] |
...
|-------------|-------------|------------------|
| **201** | The bank account was successfully created. |  -  |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **createMerchantRequest** | [**CreateMerchantRequest**](CreateMerchantRequest.md)| The request body to register a webhook endpoint. | [optional] |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **createPaymentOrderRequest** | [**CreatePaymentOrderRequest**](CreatePaymentOrderRequest.md)| The request body to create a new payment order. | [optional] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **201** | Payment order request successfully. |  -  |
| **4XX** | Bad request. Your request contains malformed syntax or invalid parameters. |  -  |
| **5XX** | Internal server error. |  -  |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **createRefundRequest** | [**CreateRefundRequest**](CreateRefundRequest.md)| The request body to create a refund transaction. | [optional] |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **createSettlementRequestRequest** | [**CreateSettlementRequestRequest**](CreateSettlementRequestRequest.md)| The request body to create a new settlement request. | [optional] |
...
<a id="getFiatRate"></a>
# **getFiatRate**
> GetFiatRate200Response getFiatRate(tokenId, fiatCurrency)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetFiatRate200Response result = apiInstance.getFiatRate(tokenId, fiatCurrency);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentApi#getFiatRate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **fiatCurrency** | **String**| The fiat currency to convert to. | [default to USD] |

### Return type

[**GetFiatRate200Response**](GetFiatRate200Response.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | The exchange rate for the given token and fiat currency. |  -  |
| **4XX** | Bad request. Your request contains malformed syntax or invalid parameters. |  -  |
| **5XX** | Internal server error. |  -  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Payment order request successfully. |  -  |
| **4XX** | Bad request. Your request contains malformed syntax or invalid parameters. |  -  |
| **5XX** | Internal server error. |  -  |
...
<a id="getRefunds"></a>
# **getRefunds**
> GetRefunds200Response getRefunds(limit, before, after, refundId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String refundId = "R20250304-M1001-1001";
    try {
      GetRefunds200Response result = apiInstance.getRefunds(limit, before, after, refundId);
      System.out.println(result);
    } catch (ApiException e) {
...
| **refundId** | **String**| The refund ID. | [optional] |
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **merchantIds** | **String**| List of merchant IDs to query. | [optional] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | The available settlement amounts for the given merchants. |  -  |
| **4XX** | Bad request. Your request contains malformed syntax or invalid parameters. |  -  |
| **5XX** | Internal server error. |  -  |
...
| **createBankAccountRequest** | [**CreateBankAccountRequest**](CreateBankAccountRequest.md)| The request body to update an existing bank account. | [optional] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | The bank account was successfully created. |  -  |
| **4XX** | Bad request. Your request contains malformed syntax or invalid parameters. |  -  |
| **5XX** | Internal server error. |  -  |
...
|------------- | ------------- | ------------- | -------------|
| **orderId** | **String**| The order ID. | |
| **updatePaymentOrderRequest** | [**UpdatePaymentOrderRequest**](UpdatePaymentOrderRequest.md)| The request body to update an existing payment order. | [optional] |
